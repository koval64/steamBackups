...
Script don't recognize if there are directory without game, so be carefull, and always check if game is running in steam, before making backup. Best solution to this is to physically remove directory after uninstalling in steam.
