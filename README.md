...
Script don't recognize if there are directory without game, so be carefull, and always check if game is running in steam, if it does't, delete directory before making any backups.
